...
def train_and_evaluate_model(
    net, x_train_data, y_train_data, x_test_data, y_test_data, name
):
    ...
    torch.save(net.state_dict(), f"model_{name}.pth")
...
def evaluate_saved_model(net, name: str, x_test_data, y_test_data):
    net.load_state_dict(torch.load(f"model_{name}.pth"))
